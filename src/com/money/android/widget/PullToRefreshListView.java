package com.money.android.widget;
...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private String doing_end_refresh = "";// 结束刷新
	...
	private void init(Context pContext) {
		...
		doing_end_refresh = pContext
				.getString(R.string.p2refresh_doing_end_refresh);
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(
				R.layout.custom_pulltorefresh_listview_head, null);
		...
		mRoundProgressBar = (RoundProgressBar) mHeadView
				.findViewById(R.id.head_RoundProgressBar1);
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(
				R.layout.custom_pulltorefresh_listview_listfooter_more, null);
	...
	public void onScroll(AbsListView pView, int pFirstVisibleItem,
		...
		if (pTotalItemCount > pVisibleItemCount) {
			...
			// pFirstVisibleItem--;
			// }
			// if (mCount == mLastItemIndex) {
			// pVisibleItemCount--;
			// }
			// mScrollListener.onScroll(pView, pFirstVisibleItem,
	...
	private void changeEndViewByState() {
		if (mCanLoadMore) {
			...
			case ENDINT_LOADING:// 刷新中
				...
				// 加载中...
				if (mEndLoadTipsTextView.getText().toString()
						.equals(doing_end_refresh)) {
					break;
				}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (mCanRefresh) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				mRoundProgressBar.setMax(mHeadViewHeight);
				...
				mRoundProgressBar.setProgress(height);
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			// mProgressBar.setVisibility(View.GONE);
			// mArrowImageView.clearAnimation();
			mArrowImageView.setImageResource(R.drawable.icon_logo);
			// 下拉刷新
			mTipsTextView.setText(R.string.p2refresh_pull_to_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
