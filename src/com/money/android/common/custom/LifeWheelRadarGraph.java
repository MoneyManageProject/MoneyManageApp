...
public class LifeWheelRadarGraph extends View{
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        for(int i=0; i<count; i++)
        {
            pts[i].x = centerX+(int)(radius*Math.cos(Math.toRadians(angle*i - 10.5)));
            pts[i].y = centerY-(int)(radius*Math.sin(Math.toRadians(angle*i - 10.5)));
